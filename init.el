...
;;(add-to-list 'package-archives '("melpa-stable" . 1"https://stable.melpa.org/packages/") t)
(package-initialize)
...
(use-package doom-themes
  ...
  (doom-themes-neotree-config)		; Enable custom neotree theme (all-the-icons must be installed!) or for treemacs users
  (setq doom-themes-treemacs-theme
	"doom-atom")                    ; use "doom-colors" for less minimal icon theme
